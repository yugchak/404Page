...
var zhCN = {
    ...
    disableGUI: '禁用图形用户界面',
    //afkid
    visibleGUI: '启动界面已显示 (Shift+q切换)',
    hiddenGUI: '启动界面已隐藏 (Shift+q切换)',
    hotkeymenu: '快捷键菜单',
    switchhidden: '切换界面隐藏 Shift+q',
    switchpip: '切换画中画模式 Shift+p',
    CurrentTimeUp30: '前进30秒 Ctrl+right',
    CurrentTimeDown30: '后退30秒 Ctrl+left',
    resetPlayRate: '正常速度播放 z',
    setPlayRateDown: '减速播放 x',
    setPlayRateUp: '加速播放 c',
...
const globalFunctional = {
    ...
    // afkid
    GUIVisible: {
    	title: () => `${configManager.getGlobalStorage('ui.firstVisible') === true ? i18n.t('hiddenGUI') : i18n.t('visibleGUI')}`,
    	desc: () => `${configManager.getGlobalStorage('ui.firstVisible') === true ? i18n.t('hiddenGUI') : i18n.t('visibleGUI')}`,
    	fn: () => {
            configManager.setGlobalStorage('ui.firstVisible', !configManager.getGlobalStorage('ui.firstVisible'));
            window.location.reload();
    	}
    },
...
`;
        ...
        //afkid
        var img$4 = "data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='1024' height='1024' viewBox='0 0 1024 1024'%3e %3cpath d='M512 466.944l233.472-233.472a31.744 31.744 0 0 1 45.056 45.056L557.056 512l233.472 233.472a31.744 31.744 0 0 1-45.056 45.056L512 557.056l-233.472 233.472a31.744 31.744 0 0 1-45.056-45.056L466.944 512 233.472 278.528a31.744 31.744 0 0 1 45.056-45.056z' fill='%23ffffff'/%3e%3c/svg%3e";
        ...
        const menuConfig = [
            ...
            {
                title: i18n.t('hotkeymenu'),
                desc: i18n.t('hotkeymenu'),
                icon: img$1,
                dropdownMenu: [
                    {
                        title: i18n.t('switchhidden'),
                        desc: i18n.t('switchhidden'),
                        action: 'toggleVisible',
                        args: null
                    },
                    {
                        title: i18n.t('switchpip'),
                        desc: i18n.t('switchpip'),
                        action: 'togglePictureInPicture',
                        args: null
                    },
                    {
                        title: i18n.t('CurrentTimeUp30'),
                        desc: i18n.t('CurrentTimeUp30'),
                        action: 'setCurrentTimeUp',
                        args: [30]
                    },
                    {
                        title: i18n.t('CurrentTimeDown30'),
                        desc: i18n.t('CurrentTimeDown30'),
                        action: 'setCurrentTimeDown',
                        args: [-30]
                    },
                    {
                        title: i18n.t('resetPlayRate'),
                        desc: i18n.t('resetPlayRate'),
                        action: 'resetPlaybackRate',
                        args: null
                    },
                    {
                        title: i18n.t('setPlayRateDown'),
                        desc: i18n.t('setPlayRateDown'),
                        action: 'setPlaybackRateDown',
                        args: -0.1
                    },
                    {
                        title: i18n.t('setPlayRateUp'),
                        desc: i18n.t('setPlayRateUp'),
                        action: 'setPlaybackRateUp',
                        args: 0.1
                    }
                ]
            },
  ...
  `
        ...
        function createLogoModTemplate() {
            ...
            //afkid
            return `<span class="h5p-logo-mod">h5player</span>`
        }
        ...
        //afkid隐藏控件
        function hiddenByElement(element, flag) {
            if (!element) { return false }
            const popupWrapId = element.getAttribute('data-popup-wrap-id');
        ...
        function toggleVisible(element) {
            ...
            if (popupWrapId) {
                ...
                if (popupWrap.style.visibility === "visible") {
                    popupWrap.style.visibility = "hidden";
                } else {
                    popupWrap.style.visibility = "visible";
                }
    ...
    `, document.body)[0];
                ...
                //afkid
                let firstVisible = configManager.getGlobalStorage('ui.firstVisible');
...
const h5Player = {
    ...
    mediaClose() {
        ...
        /*设置disable但刷新页面*/
        /*configManager.setGlobalStorage('ui.enable', false);
        window.location.reload();*/

        removetimer = null;
        settimer = configManager.get('ui.visible') * 1000;
        t.UI.hiddenByElement(player, true);
        removetimer = setTimeout(() => {
            t.UI.hiddenByElement(player, false);
        }, settimer);
